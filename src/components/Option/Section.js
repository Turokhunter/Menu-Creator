        ...
        <Form>
          <Form.Row>
            <Form.Group as={Col}>
              <InputGroup>
                <InputGroup.Prepend>
                  <InputGroup.Text id="sectionLabel">Section:</InputGroup.Text>
                </InputGroup.Prepend>
                <Form.Control
          ...
          <Form.Row>
            <Form.Group as={Col}>
              <InputGroup>
                <InputGroup.Prepend>
                  <InputGroup.Text id="hasCostTier">Has Cost Teir:</InputGroup.Text>
                </InputGroup.Prepend>
                <InputGroup.Checkbox
                  name ="hasCostTier"
                  aria-label="option 1"
                  checked = {this.props.option.hasCostTier}
                  onChange = {this.props.handleUpdate}
                />
              </InputGroup>
            </Form.Group>
            ...
            <Form.Group as={Col}>
              <InputGroup>
                <InputGroup.Prepend>
                  <InputGroup.Text id="multiSelect">MultiSelect:</InputGroup.Text>
                </InputGroup.Prepend>
                <InputGroup.Checkbox
                  name ="multiSelect"
                  aria-label="option 1"
                  checked = {this.props.option.multiSelect}
                  onChange = {this.props.handleUpdate}
                />
              </InputGroup>
            </Form.Group>
            ...
            {parameterList.map((parameter)=>
              <Col>
                <Form.Group >
                  <InputGroup >
                    <InputGroup.Prepend>
                      <InputGroup.Text > {parameter[0]}:</InputGroup.Text>
                    </InputGroup.Prepend>
                    <Form.Control
                      value= {this.props.option.costTier[parameter[1]]}
                      name= { "costTier." + parameter[1]}
                      type= "number"
                      onChange = {this.props.handleUpdate}
                    />
                  </InputGroup>
